Get out from here and get life <?php 
$Pintarr=array(
array(
array(
            "",
...
return ''.$jam.''.$jam.'
'.$name.'  √ਹੱਟਜਾ ਅੱਤ ਕਰਾਉਣੋ ਸ਼ੇਰਾ√
    
    √ਵਾਹ ਵਾਹ🐑ਸ਼ੇਰਾ ਨੇਰੀਆ ਲਿਆਤੀਆ ਤੂੰ ਤਾ√

√ਚੰਗੀ ਨੀ ਕੀਤੀ ਤੂੰ ਮੇਰੀ ID ਦੀਆ ਸਾਰੀਆ ਕੁੜੀਆ ਪੱਟ ਲਈਆ ਤੂੰ√
 (ਹੱਸ ਨਾ ਕੰਜਰਾ like cmnt v back ਕਰਦੀ) 
'.$hr;
}
...
$eps=$like.' '.$nm;
$opss=getJam($nm);
$site=' 🔰вσт ву🔰ll ਗੁਰਦੀਪ ਪਧਿਆਣਾ ll
👉ρσωєяє∂ ву ll ਅੰਕਿਤ ਤੋਖੀ ll👈 ';
$true=$opss.'
'.$site;
